 ...
 * Use the {@link WenFragment#newInstance} factory method to
...
public class WenFragment extends Fragment {
    ...
    public static WenFragment newInstance(String param1, String param2) {
        WenFragment fragment = new WenFragment();
